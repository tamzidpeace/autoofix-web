<template class="relative">
  <header class="relative border-2 border-red-500">
    <nav class="bg-white border-gray-200 dark:bg-gray-900 z-10">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://flowbite.com/" class="flex items-center">
          <img src="~/assets/img/autofixlogo.png" class="h-8 mr-3" alt="Autofix Logo" />
        </a>
        <div class="flex md:order-2">
          ...
          <button data-collapse-toggle="navbar-cta" type="button"
            class="border-2 border-red-600 inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
        ...
        <div class="items-center hidden lg:block justify-between  w-full md:flex md:w-auto md:order-1">
          <ul
  ...
  <!-- moblie view -->
  <div class="lg:hidden z-40 w-8/12 h-[800px] absolute left-[10%] bg-white shadow-amber-50 border-green-800 border-2">
    <div class="border">
      <ul class="">
        <li>
          <a href="#"
