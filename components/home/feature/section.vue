    ...
    <section class="bg-white 3xl:px-[16.25rem] 3xl:py-[7.75rem] xl:px-[10rem] lg:px-[3rem] lg:py-[4rem] px-[1rem] py-[2.75rem]">
        <section class="mb-[3rem] lg:mx-[14.88rem]">
            <div class="flex justify-center">
                <p class="font-extrabold text-2xl xl:text-4xl">Our Features</p>
            </div>
            <div class="text-center flex justify-center">
                <p class="font-normal">Fully automated Garage System(GMS) is a cloud-based mobile and responsive
                    web
        ...
        <section class="grid grid-cols-1 lg:grid-cols-2 ">
            ...
            <div class="h-full flex justify-start 2xl:pl-[76px] lg:justify-center lg:py-[3.5rem]">
                <div class="">
                        <p class="font-bold text-[24px] mb-4 lg:text-4xl">Service Center</p>
                        <p class="font-normal text-gray-6 text-base">Schedule Appointment, Estimate, Inspection & Health card, Job Card,
                            Invoice,
                            Order
                            Summary, Customer & Vehicle Master, and More Schedule Appointment, Estimate, Inspection & Health
                            card,
                            Job Card, Invoice, Order Summary.
                        </p>
                    <div class="pt-8">
                        <div class=" w-full">
                        ...
                        <div class="">
                            ...
                            <p class="ps-16 text-gray-6 pe-2">Schedule Appointment, Estimate, Inspection & Health card, Job Card, Invoice, Order Summary, Customer & Vehicle Master.</p>
                        </div>
                        <div class="">
                            <div class="flex items-center">
                                <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p class="ps-16 text-gray-6 pe-2">Schedule Appointment, Estimate, Inspection & Health card, Job Card.</p>
                        </div>
                    </div>
                </div>
            </div>
