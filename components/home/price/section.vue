<template>
    <div>
        ...
        <section class="h-[2223px] flex justify-center items-center bg-[#F2F2FD] lg:h-[64rem] lg:w-full">
            <section class="lg:w-4/6">
                <!-- description section start -->
                <section class="text-center ">
                    <p class="p-2">Our Best Pricing Plan</p>
                    <p class="text-3xl font-600 p-2">
                ...
                <div class="flex w-full justify-center">
                    <section class="lg:h-[58px] border-2 flex justify-center bg-white lg:w-3/12 rounded-full mb-10 mt-5">
                        <button
                ...
                <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:gap-4 ">
                    <!-- Price section 1 -->
                    <section
                        ...
                        <div class="pt-8">
                            ...
                            <section class="pt-4 lg:h-[450px]">
                                <section class="flex justify-center">
                                    ...
                                    <p class="m-0 mt-2 ms-2 font-[500]">
                                        / Per Month
                                    </p>
                                </section>
                                <section class="pt-6 ps-4 pe-4">
                                    <p class="text-[16px] mb-5">Perfect for Standard Packages that are just getting started.
                                        It is a long
                                        established the fact.</p>
                                    <section class="lg:h-[225px]">
                                        <div class="flex mb-2">
                                            <img class="pe-3" src="~/assets/img/righticon.png" alt="">
                                        ...
                                        <div class="flex mb-2">
                                            <img class="pe-3" src="~/assets/img/righticon.png" alt="">
                                            <p>Create Multiple Firms</p>
                                        </div>
                                        <div class="flex mb-2">
                                            <img class="pe-3" src="~/assets/img/righticon.png" alt="">
                                            <p>Check Profit on Invoices</p>
                                        </div>
                                        <div class="flex mb-2">
                                            <img class="pe-3" src="~/assets/img/righticon.png" alt="">
                                            <p>Keep different rates for each party</p>
                                        </div>
                                        <div class="flex mb-2">
                                            <img class="pe-3" src="~/assets/img/righticon.png" alt="">
                                            <p>Set multiple pricing for items</p>
                                        </div>
                                        <div class="flex">
                                            <img class="pe-3" src="~/assets/img/righticon.png" alt="">
                                            <p>Balance Sheet</p>
                                    ...
                                    <section class="pt-4 lg:pt-1">
                                        <p class="border-b-2 border-dark-500 w-3/6 border-black">+10 More Features</p>
                                    </section>
                                </section>
                            </section>
                            <section class="flex justify-center lg:mt-0 lg:h-[56px] pt-6 lg:pt-0 ">
                                <button
                                    class="w-[311px] px-10 py-4 lg:py-0 lg:w-[296px] border-2 rounded-lg text-[#646BEE] font-600">Choose
                                    Plan</button>
                            </section>
                        </div>
                    </section>
                    ...
                    <section
                        ...
                        <div class="pt-4">
                            ...
                            <section class="flex justify-center lg:mt-0 lg:h-[56px] pt-6 lg:pt-0 ">
                                <button
                                    class="w-[311px] px-10 py-4 bg-white lg:py-0 lg:w-[296px] rounded-lg text-[#646BEE] font-600">Choose
                                    Plan</button>
                            </section>
                        </div>
                    </section>
